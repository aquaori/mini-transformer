...
import { D_MODEL, EMBEDDING_SCALE } from "../config/config.js";
import { VOCAB_SIZE } from "../params/tokenizer-vocab.js";

const EMBEDDING_TABLE_PATH = new URL("../params/embedding-table.js", import.meta.url);
...
fs.writeFileSync(EMBEDDING_TABLE_PATH, fileContent, "utf8");
